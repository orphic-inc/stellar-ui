...
export interface components {
  schemas: {
    ...
    PrivateConversation: {
      ...
      /** @enum {string|null} */
      ticketStatus?: 'Unanswered' | 'Open' | 'Resolved' | null;
      createdAt: string;
      updatedAt: string;
      participants?: components['schemas']['PrivateConversationParticipant'][];
      assignedStaff?: components['schemas']['MessageUser'] & unknown;
